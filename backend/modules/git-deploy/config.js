...
const updateConfig = async (access, hostId, data) => {
	...
	if (data.git_poll_unit !== undefined && ["s", "m", "h"].includes(data.git_poll_unit)) updateData.git_poll_unit = data.git_poll_unit;
	...
	if (updateData.git_sync_enabled !== undefined || updateData.git_poll_interval !== undefined || updateData.git_poll_unit !== undefined) {
