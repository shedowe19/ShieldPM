...
router.get("/:id", async (req, res, next) => {
	try {
		...
		// Ideally we keep them but don't send back the cleartext.
...
router.post("/", async (req, res, next) => {
	...
	try {
		...
		// Set owner
		payload.owner_user_id = req.user.id;
...
/**
 * PUT /api/nginx/terminal-hosts/:id
 */
...
/**
 * DELETE /api/nginx/terminal-hosts/:id
 */
