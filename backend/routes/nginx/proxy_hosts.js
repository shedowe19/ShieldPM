...
router
	...
	.post(
		asyncHandler(async (req, res) => {
			const payload = await validate("/nginx/proxy-hosts", "post")(req.body);
...
router
	...
	.put(
		asyncHandler(async (req, res) => {
			const payload = await validate("/nginx/proxy-hosts/{hostID}", "put")(req.body);
...
router
	...
	.post(
		asyncHandler(async (req, res) => {
			...
			await validate("/nginx/proxy-hosts/{hostID}/git-sync", "post")(req.body);
...
router
	...
	.put(
		asyncHandler(async (req, res) => {
			const hostId = Number.parseInt(req.params.host_id, 10);
			const payload = await validate("/nginx/proxy-hosts/{hostID}/git-status", "put")(req.body);
