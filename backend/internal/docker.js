    ...
    async processContainer(container, client) {
        ...
        try {
            ...
            if (existingHost) {
                ...
                await internalNginx.configure(ProxyHost, "proxy", updatedHost);
                ...
                await internalNginx.configure(ProxyHost, "proxy", newHost);
    ...
    async disableContainerHost(containerId) {
        try {
            ...
            if (existingHost) {
                ...
                await internalNginx.configure(ProxyHost, "proxy", disabledHost);
