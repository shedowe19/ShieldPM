...
let streamModalModule: Promise<typeof import("src/modals/StreamModal")> | undefined;
...
const loadStreamModal = () => {
	streamModalModule ??= import("src/modals/StreamModal");
...
export { showDeleteConfirmModal, showHelpModal, showStreamModal };
