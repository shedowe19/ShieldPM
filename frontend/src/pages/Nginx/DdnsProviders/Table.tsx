    ...
    const columns = useMemo(
        () => [
            columnHelper.accessor((row) => row, {
                id: "icon",
                cell: () => {
                    return <ServiceIcon size={28} iconType="globe" />;
                },
                meta: {
                    className: "w-[50px]",
                },
            ...
            columnHelper.accessor("lastIpv4", {
                ...
                cell: (info) => {
                    ...
                    return val ? <span className="font-mono text-xs">{val}</span> : <span className="text-muted-foreground">-</span>;
                },
            }),
            ...
            columnHelper.accessor("lastError", {
                ...
                cell: (info) => {
                    ...
                    return err ? (
                        <span className="text-xs text-red-500 font-medium" title={err}>Error</span>
                    ) : (
