...
export default function AiConfigPage() {
    ...
    const onSubmit = async (values: AiConfig, { setSubmitting }: any) => {
        try {
            ...
            const payload = {
                ...values,
                num_ctx: values.num_ctx ? parseInt(String(values.num_ctx), 10) : undefined,
                num_batch: values.num_batch ? parseInt(String(values.num_batch), 10) : undefined,
                num_thread: values.num_thread ? parseInt(String(values.num_thread), 10) : undefined,
            };
