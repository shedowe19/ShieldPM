...
Übersicht aller Features von ShieldPM mit Verweis auf die jeweilige Modul-Dokumentation.

## Kontext

ShieldPM bietet eine breite Palette an Features. Diese Seite dient als Einstiegspunkt zur Feature-Dokumentation.
...
| Feature            | Modul-Dokumentation                     | Status |
| ------------------ | --------------------------------------- | ------ |
| Cloudflare Tunnels | [Cloudflared](../module/cloudflared.md) | Aktiv  |
| Tor Onion Services | [Tor](../module/tor.md)                 | Aktiv  |
| WireGuard Tunnels  | [WireGuard](../module/wireguard.md)     | Aktiv  |
| DDNS               | [DDNS](../module/ddns.md)               | Aktiv  |
